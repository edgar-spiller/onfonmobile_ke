...
import samsungData from '../../products/samsung/components/samsung.json'
                ...
                <div className="row gy-4">
                    <div className="col-xl-9">
                        <div className="row gy-4">
                            ...
                            {samsungData.products.map((product) => (
                            <div key={product.id} className="col-xl-6">
                              <div className="product-details__content">
                                ...
                                <div className="my-32 flex-align gap-16 flex-wrap">
                                  <div className="flex-align gap-8">
                                    ...
                                    <h6 className="mb-0">{product.price.deposit}</h6>
                                  </div>
                                  <div className="flex-align gap-8">
                                    <div className="flex-align gap-8 text-main-two-600">
                                      Daily Payment
                                    </div>
                                    <h6 className="mb-0">{product.price.dailyPayment}</h6>
                                  </div>
                                </div>

                                <span className="mt-32 pt-32 text-gray-700 border-top border-gray-100 d-block" />
                                <div>
                                  <h6 className="mb-24">Product Description & Specs</h6>
                                  <ul className="list-inside mt-32 ms-16">
                                    <li className="text-gray-400 mb-4">Screen Size: {product.specs.screenSize}</li>
                                    <li className="text-gray-400 mb-4">Battery: {product.specs.batteryCapacity}</li>
                                    <li className="text-gray-400 mb-4">Camera: {product.specs.camera}</li>
                                    <li className="text-gray-400 mb-4">Storage: {product.specs.storage.ram} RAM | {product.specs.storage.rom} ROM</li>
                                  </ul>
                                </div>

                                <span className="mt-32 pt-32 text-gray-700 border-top border-gray-100 d-block" />
                                <a href={product.action.link} className="btn btn-black flex-center gap-8 rounded-8 py-16">
