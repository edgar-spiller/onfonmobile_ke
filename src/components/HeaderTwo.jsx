                                ...
                                <div className="header-two-activities flex-align flex-wrap gap-32">
                                    ...
                                    >
                                        <span className="text-2xl text-gray-800 d-flex position-relative me-6 mt-6 item-hover__text">
                                            ...
                                            <span className="w-16 h-16 flex-center rounded-circle bg-main-two-600 text-gray-900 text-xs position-absolute top-n6 end-n4">
                                                2
                                            </span>
                                        </span>
                                        <span className="text-md text-gray-800 item-hover__text d-none d-lg-flex">
                                            Wishlist
                                        </span>
                                    </Link>
                                    <Link
