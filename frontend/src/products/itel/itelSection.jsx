                    ...
                    <div className="col-lg-9">
                        ...
                        <div className={`list-grid-wrapper ${grid && "list-view"}`}>
                            <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                ...
                                >
                                    <img
                                        src="assets/images/itel/Itel S23.webp"
                                        alt=""
                            ...
                            <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                ...
                                >
                                    <img
                                        src="assets/images/itel/Itel A60.webp"
                                        alt=""
                                        className="w-auto max-w-unset"
                                    />
                                </Link>
                            ...
                            <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                ...
                                >
                                    <img
                                        src="assets/images/itel/Itel P17 Pro 4G.webp"
                                        alt=""
                                        className="w-auto max-w-unset"
                                    />
                                </Link>
                            ...
                            <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                ...
                                >
                                    <img
                                        src="assets/images/itel/Itel P17 Pro 3G.webp"
                                        alt=""
                                        className="w-auto max-w-unset"
                                    />
                                </Link>
                            ...
                            <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                ...
                                >
                                    <img
                                        src="assets/images/itel/Itel P17.webp"
                                        alt=""
                                        className="w-auto max-w-unset"
                                    />
                                </Link>
