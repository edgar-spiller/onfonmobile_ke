                    ...
                    <div className="col-lg-9">
                        ...
                        <div key={product.id}>
                          <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                            ...
                            <Link
                                to={`${product.name.split(" ")[1].toLowerCase()}-${product.name.split(" ")[2]}`} state={{data:product}}
                            ...
                            <div className="product-card__content mt-16">
                              <h6 className="title text-lg fw-semibold mt-12 mb-8">
                                <Link to={product.detailsLink} className="link text-line-2">
                                  {product.name}
                                </Link>
                              </h6>
                              ...
                              <div className="mt-8">
                                <span className="text-gray-900 fw-normal">{product.storage}</span>
                                <div
                              ...
                              <div className="product-card__price my-20">
                                <span className="text-gray-900 fw-normal">Lipa Daily {product.dailyPayment}</span>
                              </div>
