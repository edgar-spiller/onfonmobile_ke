                    ...
                    <div className="col-lg-9">
                        ...
                        <div className={`list-grid-wrapper ${grid && "list-view"}`}>
                            <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                ...
                                >
                                    <img
                                        src="assets/images/tecno/Tecno Spark 9T.webp"
                                        alt=""
                            ...
                            <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                ...
                                >
                                    <img
                                        src="assets/images/tecno/Tecno Spark 9.webp"
                                        alt=""
                                        className="w-auto max-w-unset"
                                    />
                                </Link>
                            ...
                            <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                ...
                                >
                                    <img
                                        src="assets/images/tecno/Tecno Spark 8c.webp"
                                        alt=""
                                        className="w-auto max-w-unset"
                                    />
                                </Link>
                            ...
                            <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                ...
                                >
                                    <img
                                        src="assets/images/tecno/Tecno Spark 7.webp"
                                        alt=""
                                        className="w-auto max-w-unset"
                                    />
                                </Link>
                            ...
                            <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                ...
                                >
                                    <img
                                        src="assets/images/tecno/Tecno Pop 7.webp"
                                        alt=""
                                        className="w-auto max-w-unset"
                                    />
                                </Link>
                            ...
                            <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                ...
                                >
                                    <img
                                        src="assets/images/tecno/Tecno Camon 19.webp"
                                        alt=""
                                        className="w-auto max-w-unset"
                                    />
                                </Link>
